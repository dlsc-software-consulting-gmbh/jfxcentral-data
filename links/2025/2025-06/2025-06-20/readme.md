...
* [**APIdia** published the JavaDoc of FXGL](https://apidia.net/mvn/com.github.almasb/fxgl-framework/21.1/) "_BUT, FXGL is partly written in Kotlin, which is currently not supported yet. The docs only comprise data from Java sources._"
