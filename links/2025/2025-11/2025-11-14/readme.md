...
* **Gerrit Grunwald** updated SpaceFX to Java(FX) 25. [Downloads are available on GitHub](https://github.com/HanSolo/SpaceFX/releases).

## Tutorials

* Just like last week, **Troels Mortensen** published more tutorials on YouTube:
...
* [**Gerrit Grunwald** has fans! ;-)](https://bsky.app/profile/hansolo.eu/post/3m5fzwwhuoc2l): "_Yesterday at the event of the Amsterdam JUG, someone from the audience came to me after my session and thanked me for creating the JavaFX libraries I did create... It always makes me really happy to see people use the things that I just created for the fun of it. Love the Java Community._"
