...
DemoFX is a performance test platform for JavaFX. It can layer and schedule effects on a timeline.
...
It is used to discover the best techniques for optimising JavaFX performance on the Raspberry Pi and Desktop.
